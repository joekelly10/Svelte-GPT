...
echo -e "  ${blue_bold}➜ ${white_bold}Local: ${cyan}http://localhost:${cyan_bold}1336${cyan}/${reset}"
echo -e "  ${blue_bold}➜ ${white_bold}Admin: ${yellow}http://localhost:${yellow_bold}1336${yellow}/_/${reset}"
echo -e "\n"
